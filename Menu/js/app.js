...
var CELULAR_EMPRESA = '5531994132010'
...
cardapio.metodos = {
    ...
    // botao remover o item do carrinho
    ...
    // API viacCEP
    buscarCep: () => {
        // cria variavel com o valor CEP
        var cep = $("#txtCEP").val().trim().replace(/\D/g, '')

        // verifica se o CEP possui valor informado
        if(cep != ""){

            // expressao regular para validar CEP / regex
            var validacep = /^[0-9]{8}$/;
    ...
    // validação antes de prossegir para a etapa 3
    resumoPedido: () => {
        ...
        if(cep.length <= 0){
            cardapio.metodos.mensagem("Informe um CEP, por favor.")
            $("#txtCEP").focus();
            return
        }
    ...
    // atualiza o link do botao do wpp
    finalizarPedido: () => {
